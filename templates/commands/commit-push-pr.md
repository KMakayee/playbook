...
3. Show the message to the developer and ask: "Commit with this message? (edit or confirm)"
4. Once confirmed, commit and push to the current branch.
5. Check whether an open PR already exists for this branch:
