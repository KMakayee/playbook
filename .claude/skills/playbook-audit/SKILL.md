---
name: playbook-audit
description: Run a periodic health check on the RDPI playbook configuration.
...
3. Read `.claude/templates/audit-report.md` to know the output format.
...
Write the audit report to `tasks/audit-report.md` using the structure from `.claude/templates/audit-report.md`. Fill in all sections based on what happened in Steps 1–4:
...
- **No `.claude/templates/audit-report.md`:** Create `tasks/audit-report.md` using the structure defined in Step 6 above directly. Mention that the template file is missing.
