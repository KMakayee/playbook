---
name: commit
description: Review staged changes and create a well-formed git commit.
...
6. **Reflect** — Scan the reflection prompt in `.claude/templates/error-report.md`. If anything from this session is worth logging, append a learning entry to `tasks/errors.md`.
