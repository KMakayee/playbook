---
name: issue-plan
description: Build an implementation plan for an issue from its research artifact, cross-checked with Codex.
...
- Append them to `tasks/deferred.md` using the structure from `.claude/templates/deferred.md`.
